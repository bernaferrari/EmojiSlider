...
//
//class ProfilePicture(context: Context) : Drawable(), Callback {
//    internal val f32860a: textDrawable
//    internal val averageHandle: AverageCircle
//
...
//        this.averageHandle = AverageCircle(context)
//        this.averageHandle.callback = this
//        this.averageHandle.outerColor = ContextCompat.getColor(context, R.color.colorPrimary)
//    }
//
