...
//        this.f32887e.setHandleSize(resources.getDimensionPixelSize(R.dimen.slider_sticker_tray_slider_handle_size));
//        this.f32887e.m18486a(C5186e.EMOJI);
//        this.f32887e.setTrackHeight(resources.getDimensionPixelSize(R.dimen.slider_sticker_tray_track_height));
//    }
//
