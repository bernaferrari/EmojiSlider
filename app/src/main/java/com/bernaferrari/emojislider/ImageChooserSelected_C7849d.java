...
//        Logger.d("f20875a ordinal value is: " + f20875a[c5186e.ordinal()]);
        switch (f20875a[c5186e.ordinal()]) {
            case 1:
                drawable = this.imageHandle_f32861b;
                break;
            case 2:
                drawable = this.imageHandle_f32861b;
                break;
...
//                throw new IllegalStateException(stringBuilder.toString());
    ...
    public final void setAlpha(int i) {
        ...
        this.imageHandle_f32861b.setAlpha(i);
    ...
    public final void setBounds(int i, int i2, int i3, int i4) {
        ...
        this.imageHandle_f32861b.setBounds(i, i2, i3, i4);
        this.f32862c.setBounds(i, i2, i3, i4);
    }

    public final void setColorFilter(ColorFilter colorFilter) {
        this.f32860a.setColorFilter(colorFilter);
        this.imageHandle_f32861b.setColorFilter(colorFilter);
